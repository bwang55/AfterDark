  ...
  return (
    <div className="pointer-events-auto flex flex-col items-end gap-1.5">
      ...
      >
        ...
        <span className="text-xs font-medium text-white/70">Controls</span>
        {open ? (
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="w-[240px] origin-top overflow-hidden rounded-2xl border border-white/10 bg-slate-900/70 shadow-xl backdrop-blur-xl"
          >
            <div className="space-y-3 p-3">
              ...
              <div>
                ...
                <div className="mt-2 space-y-2.5">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] text-white/60">Tilt</span>
                    ...
                    <input
                      ...
                      className="h-1 w-full cursor-pointer appearance-none rounded-full bg-white/10 accent-sky-400 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-sky-400 [&::-webkit-slider-thumb]:shadow-md"
                    />
                  ...
                  <button
                    type="button"
                    onClick={resetNorth}
                    className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-[11px] text-white/60 transition hover:bg-white/[0.06] hover:text-white/80"
                  >
                ...
                {/* Gesture hint */}
                <p className="mt-1.5 text-[9px] leading-relaxed text-white/20">
    ...
    <label className="flex cursor-pointer items-center justify-between">
      ...
      <button
        ...
        className={`relative h-5 w-9 rounded-full transition-colors ${
          checked ? "bg-sky-400/40" : "bg-white/10"
        }`}
      >
        <span
